...
M0.5-003 Preview deployment target作成:未完了
M0.5-004 main branchからProduction自動更新:未完了
M0.5-005 branch/commit Preview deployment:未完了
M0.5-006 Preview URL固定導線:未完了
M0.5-007 COOP header構成:未完了
M0.5-008 COEP header構成:未完了
M0.5-009 cross-origin isolation対応asset配信:未完了
M0.5-010 critical asset self-hosting:未完了
M0.5-011 公開版build SHA表示:未完了
M0.5-012 公開版diagnostics入口:未完了
M0.5-013 secure-context runtime確認導線:未完了
M0.5-014 PreviewからPWA manifest取得可能化:未完了
...
M2-020 mask single-channel persistence:未完了
...
M2-044 garbage collection foundation:未完了
M2-検査 M2内部検査:未完了
...
M3-030 frame compositor foundation:未完了
